...
def test_suite():
	...
	__test__.add_decision("dorc", "Are you going to make a %DECISION% or a %CHOICE%?", {'DECISION': 'story_d', 'CHOICE': 'story_c'})
	__test__.add_story("story_d", "This is the end of the test. You chose to make a %Decision%", False)
	__test__.add_story('story_c', "This is the end of the test. You decided to make a %Choice%", False)
